<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <b-overlay :show="isLoading" variant="secondary" blue="2px" opacity=".66" rounded="sm">
                    <b-card header-tag="header" class="shadow">
                        ...
                        <b-card-text>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" @keyup="formErrors.starting_package = ''" class="form-control form-control-sm" :class="{ 'is-invalid': formErrors.starting_package }" placeholder="Enter your starting package price." v-model="formData.starting_package" required>
                            ...
                            <button class="btn btn-sm btn-secondary" @click.prevent="submit">
                                Submit
                            </button>
                        </b-card-text>
                    </b-card>
