<template>
    <b-modal :id="'delete-package-'+item.id" :ref="'delete-package-modal'+item.id" title="Delete Package">
        <div class="alert alert-danger">Are you sure you want to delete this package?</div>
        <div slot="modal-footer">
            <button class="btn btn-outline-secondary" @click.prevent="hideModal(item.id)">Cancel</button>
