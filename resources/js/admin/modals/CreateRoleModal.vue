<template>
  <b-modal id="create-role" title="Create Role">
    <form>
      ...
      <div class="form-group">
        ...
        >
          ...
          <option value="photographer">Photographer Guard</option>
          <option value="client">Client Guard</option>
        </select>
        <div v-if="formErrors.guard_name" class="invalid-feedback">{{ formErrors.guard_name[0] }}</div>
      </div>
    </form>
